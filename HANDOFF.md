...
- La interfaz financiera y ARAYA Asistente presentan el corte vivo y la
  composición completa. Versión de ingesta `2026-08-22.4`, prompt
  `araya-ingestion-agent-2026-08-22-v4`. En balances fiduciarios el agente debe
...
- Si un documento complejo consume todas las rondas consultando herramientas,
