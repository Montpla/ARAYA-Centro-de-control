const financeOnlyDocuments = new Set([
  "/data-center/junio-2026/avance-fisico-y-cubicaciones-junio-2026.xls",
  "/data-center/junio-2026/araya-informe-junio-2026.pptx",
  "/data-center/junio-2026/presentacion-informe-araya-junio-2026.pdf",
  ...
  "/data-center/junio-2026/informe-ventas-araya-junio-2026.pptx",
  ...
  "/data-center/julio-2026/informe-analisis-proveedores-2026-07-30.pdf",
...
const financeDocumentPathPattern =
  /(?:^|[-/])(finanzas?|financiero|fideicomiso|balance|resultados?|flujo|cxp|presupuesto|desviacion|prestamo|ifc|antonely|comercial|ventas?|cobranza|morosidad|reservas?)(?:[-./]|$)/i;
