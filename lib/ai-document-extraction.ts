...
- safetyMetrics no tiene fecha propia: es la fotografía de la semana más reciente, no una serie. Antes de publicarlo usa read_current_value sobre safetyWeeklySeries (o sobre el propio safetyMetrics) para ver de qué semana es el dato ya publicado. Si el reporte que estás leyendo es de una semana MÁS ANTIGUA que esa, no publiques safetyMetrics con sus cifras -pisarías la semana más reciente con una vieja-: publica solo su fila en safetyWeeklySeries y explica en warnings que ese reporte llegó fuera de orden. Cuando se suben varias semanas juntas, esto puede pasar aunque cada una individualmente esté bien leída.
